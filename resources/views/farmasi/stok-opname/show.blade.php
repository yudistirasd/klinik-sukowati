...
@section('title', 'Rincian Stok Opname Obat')
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-actions">
            @if ($stokOpname->insert_stok == 'belum')
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover table-sm" id="stokOpname-detail-table">
              <thead>
                <tr>
...
@push('js')
  ...
  <script>
    ...
    const table = new DataTable('#stokOpname-detail-table', {
      dom: 'Brti',
      processing: true,
      serverSide: true,
      autoWidth: false,
    ...
    const insertStok = () => {
      Swal.fire({
        title: "Apakah anda yakin menambahkan data stokOpname obat ke stok?",
        ...
        preConfirm: async (login) => {
          return $.ajax({
            url: route('api.farmasi.stok-opname.store-stok', stokOpname.id),
            method: 'POST',
            headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
