...
@section('action-page')
  <a href="#" class="btn btn-primary btn-5" onclick="handleModal('create', 'Tambah Pemeriksaan Laboratorium')">
        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="handleSubmit" autocomplete="off">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                <label class="form-label required">Tarif RJ</label>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="mb-3">
                    <label class="form-label required">Nilai Normal Laki Laki</label>
                    <input type="text" class="form-control" autocomplete="off" x-model="form.nilai_normal_laki_laki" :class="{ 'is-invalid': errors.nilai_normal_laki_laki }">
                    <div class="invalid-feedback" x-text="errors.nilai_normal_laki_laki"></div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="mb-3">
                    <label class="form-label required">Nilai Normal Perempuan</label>
                    <input type="text" class="form-control" autocomplete="off" x-model="form.nilai_normal_perempuan" :class="{ 'is-invalid': errors.nilai_normal_perempuan }">
                    <div class="invalid-feedback" x-text="errors.nilai_normal_perempuan"></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    const table = new DataTable('#tindakan-table', {
      ...
      columns: [{
        ...
        },
        {
          ...
          name: 'nilai_normal_laki_laki',
          sClass: 'text-center'
        },
        {
          data: 'nilai_normal_perempuan',
          name: 'nilai_normal_perempuan',
          sClass: 'text-center'
        },
        {
          data: 'tarif',
    ...
    document.addEventListener('alpine:init', () => {
      Alpine.data('form', () => ({
        ...
        form: {
          ...
          tarif: '',
          jenis: 'laborat',
          nilai_normal_laki_laki: '',
          nilai_normal_perempuan: '',
        },
        endPoint: '',
        errors: {},
        loading: false,
